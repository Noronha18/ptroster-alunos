...
export default function Historico() {
  ...
  return (
    <div className="min-h-screen bg-ios-background px-4 pt-14 pb-6">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-gray-900 tracking-tight">Histórico</h1>
      ...
      {historico.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-gray-500 font-medium">Nenhuma aula registrada ainda.</p>
        </div>
      ) : (
        <div className="space-y-4">
          {historico.map((sessao) => (
            <div key={sessao.id} className="bg-white rounded-2xl border border-ios-border p-4 shadow-sm flex items-center gap-4">
